...
SPECIMEN_DIR="$VIVARIUM_DIR/opensim-core-master"
...
EOF
    ...
    <Project>
 <PropertyGroup>
    <!-- prevent warning MSB3243: No way to resolve conflict between "System.Drawing.Common, Version=6.0.0.0, Culture=neutral, PublicKeyToken=cc7b13ffcd2ddd51" and "System.Drawing.Common". Choosing "System.Drawing.Common, Version=6.0.0.0, Culture=neutral, PublicKeyToken=cc7b13ffcd2ddd51" arbitrarily. -->
...
oscsc $SCRIPT_DIR/../plugins/MiniJanus.cs bin/MiniJanus.dll
